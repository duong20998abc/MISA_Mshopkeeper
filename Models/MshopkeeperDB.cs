        ...
        public static List<Document> Documents = new List<Document>
            {
                ...
                new Document{ DocumentId = new Guid("edfd4dfa-22ac-4ed6-a768-c8f84dc5d0e5"), DocumentCode = "PC00007131", DocumentDate = new DateTime(2019,4,15), Reason = "Lương tháng 5", DocumentTypeId = new Guid("c6e3e2a8-384c-4528-baea-36b09ef2d812"), PersonId = new Guid("29eab216-552e-4716-9111-1aa841edc3bf"), TotalMoney = 15000000, MoneyHasToPay = 950000, MoneyHasNotPaid = 950000, AmountPaid = 0, EmployeeId = new Guid("49d59456-856c-4552-a08c-16a54558545e")},
